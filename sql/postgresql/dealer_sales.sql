...
VALUES
    ...
    (26022, 1, '订单录入', 'dealer.quickOrder.menu', 26000, 4, 'quickOrders', 'dealer-quick-order/list', '1', '0', 'C', '1', '1', 'dealer:quick-order:list', 'cart', 'system', now(), ''),
    (26024, 1, '订单配置', 'dealer.quickOrder.workbenchTitle', 26000, 41, 'quickOrders/workbench', 'dealer-quick-order/workbench', '1', '0', 'C', '0', '1', 'dealer:quick-order:add', '#', 'system', now(), '订单录入隐藏工作台'),
    (26025, 1, '订单复核', 'dealer.quickOrder.reviewTitle', 26000, 42, 'quickOrders/review', 'dealer-quick-order/review', '1', '0', 'C', '0', '1', 'dealer:quick-order:edit', '#', 'system', now(), '订单录入隐藏复核页'),
    ...
    (26703, 1, '下单记录', 'platform.sales.quickOrders', 26700, 3, 'quickOrders', 'platform-sales/quick-orders', '1', '0', 'C', '1', '1', 'platform:sales:quick-order:list', 'cart', 'system', now(), '阶段 12 薄壳'),
    (26704, 1, '销售订单', 'platform.sales.orders', 26700, 4, 'orders', 'platform-sales/orders', '1', '0', 'C', '1', '1', 'platform:sales:order:list', 'order', 'system', now(), '阶段 12 薄壳'),
...
FROM (VALUES
    ...
    (26031, '查看订单', 'dealer.quickOrder.query', 26022, 1, 'dealer:quick-order:query'),
    (26032, '新增订单', 'dealer.quickOrder.add', 26022, 2, 'dealer:quick-order:add'),
    (26033, '修改订单', 'dealer.quickOrder.edit', 26022, 3, 'dealer:quick-order:edit'),
    (26034, '删除订单', 'dealer.quickOrder.remove', 26022, 4, 'dealer:quick-order:remove'),
