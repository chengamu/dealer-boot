package com.bocoo.common.encrypt.filter;
...
import com.bocoo.common.encrypt.annotation.ApiEncrypt;
import com.bocoo.common.encrypt.properties.ApiDecryptProperties;
            ...
            if (StringUtils.isNotBlank(headerValue)) {
                ...
                if (ObjectUtil.isNotNull(apiEncrypt)) {
                    ...
                    exceptionResolver.resolveException(
                        ...
                        ServiceException.ofMessageKey("api.encrypt.permission.denied").setCode(HttpStatus.FORBIDDEN));
                    return;
                }
            }
        }
