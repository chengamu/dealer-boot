...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static Long toLong(Object obj, Long defaultValue) {
        return obj == null ? defaultValue : Convert.toLong(obj, defaultValue);
    }
    ...
    public static Integer toInt(Object obj, Integer defaultValue) {
        return obj == null ? defaultValue : Convert.toInt(obj, defaultValue);
    }
    ...
    public static Boolean toBoolean(Object obj, Boolean defaultValue) {
        return obj == null ? defaultValue : Convert.toBool(obj, defaultValue);
    }
    ...
    public static Double toDouble(Object obj, Double defaultValue) {
        return obj == null ? defaultValue : Convert.toDouble(obj, defaultValue);
    }
    /**
     * 将分隔字符串转为 List<String>
     *
     * @param str 输入字符串 (例: "a,b,c")
     * @return List<String>
     */
     ...
     * 将分隔字符串转为 List<Long>
     *
     * @param str 输入字符串 (例: "1,2,3")
     * @return List<Long>
     */
    public static List<Long> toLongList(String str) {
        return splitTo(str, SEPARATOR, Convert::toLong);
    }

    /**
     * 将分隔字符串转为 List<Integer>
     *
     * @param str 输入字符串 (例: "1,2,3")
     * @return List<Integer>
     */
    public static List<Integer> toIntList(String str) {
        return splitTo(str, SEPARATOR, Convert::toInt);
    }
