<template>
  <div class="app-container merchant-table-page">
    ...
    <el-row :gutter="10" class="mb8 merchant-table-page__toolbar">
      <el-button type="primary" icon="Plus" @click="openAdd" v-hasPermi="['merchant:level:add']">{{ t('common.add') }}</el-button>
      <el-button plain icon="Edit" :disabled="single" @click="openEdit()" v-hasPermi="['merchant:level:edit']">{{ t('common.edit') }}</el-button>
      ...
      <el-button plain icon="Download" @click="handleExport" v-hasPermi="['merchant:level:export']">{{ t('common.export') }}</el-button>
