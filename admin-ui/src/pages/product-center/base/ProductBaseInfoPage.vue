...
const configs = computed<ProductGridConfig[]>(() => [
  {
    ...
    fields: [
      { prop: 'categoryCode', labelKey: 'productCenter.category.code', search: true, required: true, align: 'left' },
      { prop: 'categoryNameCn', labelKey: 'productCenter.category.name', search: true, required: true, align: 'left' },
      { prop: 'categoryNameEn', labelKey: 'productCenter.category.nameEn', align: 'left' },
  ...
  },
  {
    ...
    fields: [
      { prop: 'materialCode', labelKey: 'productCenter.material.code', search: true, required: true, sortable: true, align: 'left', sectionKey: 'basic', sectionLabelKey: 'productCenter.formSection.basic' },
      { prop: 'materialNameCn', labelKey: 'productCenter.material.nameCn', search: true, required: true, sortable: true, align: 'left', minWidth: 180, sectionKey: 'basic' },
      { prop: 'materialNameEn', labelKey: 'productCenter.material.nameEn', align: 'left', minWidth: 200, sectionKey: 'basic' },
      ...
      { prop: 'materialTypeNameCn', labelKey: 'productCenter.material.type', form: false, align: 'left', minWidth: 150 },
      { prop: 'attributeGroupNameCn', labelKey: 'productCenter.material.attributeGroup', form: false, align: 'left', minWidth: 130 },
      { prop: 'model', labelKey: 'productCenter.material.model', sortable: true, align: 'left', minWidth: 140, sectionKey: 'spec', sectionLabelKey: 'productCenter.formSection.spec' },
      ...
      { prop: 'manufacturerName', labelKey: 'productCenter.material.manufacturerName', form: false, sortable: true, align: 'left', minWidth: 160 },
      { prop: 'auditBy', labelKey: 'productCenter.material.auditBy', form: false, align: 'left', minWidth: 120 },
      { prop: 'auditTime', labelKey: 'productCenter.material.auditDate', type: 'date', form: false, minWidth: 120 },
      { prop: 'createBy', labelKey: 'productCenter.material.createBy', form: false, align: 'left', minWidth: 120 },
  ...
  },
  {
    ...
    defaultSort: { prop: 'sortOrder', order: 'ascending' },
    fields: [
      { prop: 'manufacturerCode', labelKey: 'productCenter.manufacturer.code', search: true, required: true, sortable: true, width: 140, align: 'left' },
      { prop: 'manufacturerName', labelKey: 'productCenter.manufacturer.name', search: true, required: true, sortable: true, minWidth: 180, align: 'left' },
      { prop: 'manufacturerShortName', labelKey: 'productCenter.manufacturer.shortName', minWidth: 140, align: 'left' },
      ...
      { prop: 'contactName', labelKey: 'productCenter.manufacturer.contactName', minWidth: 140, align: 'left' },
      { prop: 'contactPhone', labelKey: 'productCenter.manufacturer.contactPhone', minWidth: 150, align: 'left' },
      { prop: 'address', labelKey: 'productCenter.manufacturer.address', type: 'textarea', minWidth: 220, align: 'left' },
      { prop: 'status', labelKey: 'productCenter.common.status', type: 'status', search: true },
      { prop: 'sortOrder', labelKey: 'productCenter.common.sortOrder', type: 'number', sortable: true },
      { prop: 'remark', labelKey: 'productCenter.common.remark', type: 'textarea', table: false, formSpan: 2 }
    ]
  },
  {
    ...
    fields: [
      ...
      { prop: 'attributeGroupNameCn', labelKey: 'productCenter.baseAttribute.groupName', form: false, align: 'left' },
      { prop: 'attributeCode', labelKey: 'productCenter.baseAttribute.code', search: true, required: true, sortable: true, align: 'left' },
      { prop: 'attributeNameCn', labelKey: 'productCenter.baseAttribute.name', search: true, required: true, sortable: true, align: 'left' },
      { prop: 'attributeNameEn', labelKey: 'productCenter.baseAttribute.nameEn', align: 'left' },
      { prop: 'valueType', labelKey: 'productCenter.baseAttribute.valueType', type: 'select', options: valueTypeOptions.value, required: true, align: 'left' },
      { prop: 'unitCode', labelKey: 'productCenter.baseAttribute.unitCode', type: 'select', options: unitOptions.value, visible: (form) => form.valueType === 'NUMBER', align: 'left' },
  ...
  },
  {
    ...
    defaultSort: { prop: 'sortOrder', order: 'ascending' },
    fields: [
      { prop: 'unitCode', labelKey: 'productCenter.unit.code', search: true, required: true, sortable: true, align: 'left' },
