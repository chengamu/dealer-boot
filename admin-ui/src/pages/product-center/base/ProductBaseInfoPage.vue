...
const configs = computed<ProductGridConfig[]>(() => [
  ...
  },
  {
    ...
    fields: [
      ...
      { prop: 'materialNameCn', labelKey: 'productCenter.material.nameCn', search: true, required: true, sortable: true, minWidth: 180, sectionKey: 'basic' },
      { prop: 'materialNameEn', labelKey: 'productCenter.material.nameEn', minWidth: 200, sectionKey: 'basic' },
