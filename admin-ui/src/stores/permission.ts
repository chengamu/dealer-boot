...
const migratedViewModules: Record<string, () => Promise<unknown>> = {
  ...
  'merchant/profile': () => import('@/pages/merchant/MerchantProfilePage.vue'),
  'merchant/user': () => import('@/pages/merchant/MerchantUserPage.vue'),
  'product-center/workbench': () => import('@/pages/product-center/workbench/ProductCenterWorkbenchPage.vue'),
  'product-center/base': () => import('@/pages/product-center/base/ProductBaseInfoPage.vue'),
  'product-center/model': () => import('@/pages/product-center/model/ProductModelPage.vue'),
  ...
  'product-master/workbench': () => import('@/pages/product-center/workbench/ProductCenterWorkbenchPage.vue'),
  ...
  'product-config/models': () => import('@/pages/product-center/model/ProductModelPage.vue'),
  'product-config/sales-variants': () => import('@/pages/product-center/model/ProductModelPage.vue'),
