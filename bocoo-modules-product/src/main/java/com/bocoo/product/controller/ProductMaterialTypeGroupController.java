...
@RestController
@RequestMapping("/product-capability/material-type-groups")
@Tag(name = "物料类型分组", description = "物料类型分组增删改查、状态和引用检查接口")
public class ProductMaterialTypeGroupController extends BaseController {
    ...
    public TableDataInfo<ProductMaterialTypeGroupVo> list(ProductMaterialTypeGroupBo bo, PageQuery pageQuery) {
    ...
    public R<List<ProductMaterialTypeGroupVo>> options(ProductMaterialTypeGroupBo bo) {
    ...
    public R<ProductMaterialTypeGroupVo> getById(@PathVariable Long id) {
    ...
    public R<Void> add(@Validated @RequestBody ProductMaterialTypeGroupBo bo) {
    ...
    public R<Void> edit(@Validated @RequestBody ProductMaterialTypeGroupBo bo) {
