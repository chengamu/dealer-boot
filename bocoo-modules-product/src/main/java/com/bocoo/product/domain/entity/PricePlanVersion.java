...
/**
 * 价格方案版本表 pc_price_plan_version
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("pc_price_plan_version")
@Schema(description = "价格方案版本表")
public class PricePlanVersion extends BaseEntity {

    /**
     * 价格方案版本ID
     */
    @TableId(value = "price_plan_version_id")
