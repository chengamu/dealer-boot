...
/**
 * 产品能力快照实例表 pc_product_snapshot_instance
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("pc_product_snapshot_instance")
@Schema(description = "产品能力快照实例表")
public class ProductSnapshotInstance extends BaseEntity {
