...
@AutoMapper(target = ProductPublishPackage.class, reverseConvertGenerate = false)
@Schema(description = "产品发布包业务对象")
public class ProductPublishPackageBo extends BaseBo {
