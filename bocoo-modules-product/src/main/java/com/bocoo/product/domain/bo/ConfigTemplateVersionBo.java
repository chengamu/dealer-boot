...
@AutoMapper(target = ConfigTemplateVersion.class, reverseConvertGenerate = false)
@Schema(description = "配置模板版本业务对象")
public class ConfigTemplateVersionBo extends BaseBo {
